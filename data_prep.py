...
def main():
    f_test = open("./CUB_200_2011/train_test_split.txt", "r")
    f_path = open("./CUB_200_2011/images.txt", "r")
    f_crop = open("./CUB_200_2011/bounding_boxes.txt", "r")
    ...
    for line_test, line_path, line_crop in zip(f_test.readlines(), f_path.readlines(), f_crop.readlines()):
        ...
        im = Image.open("./CUB_200_2011/images/" + path)
        ...
        if test:
            ...
            shutil.copy("./CUB_200_2011/images/" + path, dest_fpath)
